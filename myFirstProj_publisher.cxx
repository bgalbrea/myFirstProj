...
rtiddsgen -language C++ -example <arch> myFirstProj.idl
...
objs/<arch>/myFirstProj_subscriber <domain_id> <sample_count>

(3) Start the publication with the command
objs/<arch>/myFirstProj_publisher <domain_id> <sample_count>
...
objs/<arch>/myFirstProj_publisher <domain_id> o
objs/<arch>/myFirstProj_subscriber <domain_id> 

On Windows:

objs\<arch>\myFirstProj_publisher <domain_id>  
objs\<arch>\myFirstProj_subscriber <domain_id>    
